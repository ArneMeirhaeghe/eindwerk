// File: src/components/formbuilder/settings/RadioGroupSettings.tsx
...
export default function RadioGroupSettings({ comp, onUpdate }: Props) {
  const opts = (comp.settings.options as string[]) || [];
  return (
    <div className="space-y-4 p-2">
      <h4 className="text-sm font-semibold">Radiogroep</h4>
      <div>
