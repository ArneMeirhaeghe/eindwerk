// File: src/components/formbuilder/settings/CheckboxSettings.tsx
...
export default function CheckboxSettings({ comp, onUpdate }: Props) {
  const opts = (comp.settings.options as string[]) || [];
  return (
    <div className="space-y-4 p-2">
      <h4 className="text-sm font-semibold">Checkbox-groep</h4>
      <div>
