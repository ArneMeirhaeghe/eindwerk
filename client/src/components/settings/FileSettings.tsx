// /src/components/settings/FileSettings.tsx
    ...
    <div className="space-y-6">
          ...
          <ul className="max-h-48 overflow-y-auto space-y-1">
            {uploads.map(item => (
              ...
              >
                ...
                <span className="flex-1 text-sm text-gray-800">{item.filename}</span>
                <button
      ...
      <div className="space-y-1">
        ...
        <input
          type="text"
          value={p.filename}
          onChange={e => onUpdate({ ...comp, props: { ...p, filename: e.target.value } })}
      ...
      <div className="flex items-center space-x-2">
        <input
          type="checkbox"
          checked={p.showName}
          onChange={e => onUpdate({ ...comp, props: { ...p, showName: e.target.checked } })}
