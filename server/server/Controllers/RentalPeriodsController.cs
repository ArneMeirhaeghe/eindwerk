...
namespace server.Controllers
{
    ...
    public class RentalPeriodsController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<List<RentalPeriod>>> GetAll()
        {
        ...
        public async Task<ActionResult<RentalPeriod>> GetById(string id)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<RentalPeriod>> Create([FromBody] RentalPeriod rental)
        {
        ...
        public async Task<IActionResult> Update(string id, [FromBody] RentalPeriod updated)
        {
